...
module.exports = {
    ...
    output: {
        path: __dirname + "/assets",      //打包后的文件存放的地方
    ...
    // 配置本地的服务器
    devServer: {
        contentBase: "./src",    //本地服务器所加载的页面所在的目录 默认webpack-dev-server会为根文件夹提供本地服务器，如果想为另外一个目录下的文件提供本地服务器，应该在这里设置其所在目录（本例设置到“public"目录）
